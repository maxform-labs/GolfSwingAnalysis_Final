...
def analyze_folders(base_path, start_folder=2, end_folder=20):
    """2-20번 폴더 분석"""
    print("=" * 80)
    print("7번 아이언 이미지 폴더 분석 (2-20번)")
    print("=" * 80)
...
def verify_cleanup(base_path, start_folder=2, end_folder=20):
    """정리 후 검증"""
    print("\n" + "=" * 80)
    print("정리 검증")
    print("=" * 80)
...
def main():
    """메인 실행 함수"""
    base_path = r"C:\src\GolfSwingAnalysis_Final\data\1440_300_data\7i"

    print("7번 아이언 이미지 폴더 정리 스크립트")
    print("=" * 80)
    ...
    # 1단계: 분석
    print("\n[1단계] 폴더 분석 중...")
    folder_info = analyze_folders(base_path, start_folder=2, end_folder=20)
    ...
    if user_input == 'y':
        ...
        # 5단계: 검증
        print("\n[4단계] 정리 검증 중...")
        verify_cleanup(base_path, start_folder=2, end_folder=20)

...
class RealisticOptimizedAnalyzer:
    def __init__(self):
        # 캘리브레이션 파라미터
    ...
    def analyze_club_optimized(self, club_name, max_shots=3):
        """최적화된 클럽 분석"""
        print(f"\n=== {club_name} 최적화 분석 ===")
...
def main():
    analyzer = RealisticOptimizedAnalyzer()
    ...
    # 보고서 저장
    report_file = "realistic_optimized_analysis_report.md"
